...
브랜치: `main`  
최신 커밋 시점의 앱 버전: `0.1.79-20260923`
...
- GitHub Release에 `0.1.79` 설치파일 업로드
- 실행 중 메인 패널은 작업 표시줄에도 아이콘이 보임 (`skipTaskbar: false`). 업무 그림·메모 창은 표시줄에 없음
...
- 홈 검색 순서: 관련 도구 → 최근 사용 → 이 PC 폴더 → 학교 → 관련 업무. 키보드 이동 순서도 같음
