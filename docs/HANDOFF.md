...
브랜치: `main`  
최신 커밋 시점의 앱 버전: `0.1.59-20260921`
...
- GitHub Release에 `0.1.59` 설치파일 업로드
...
- 처음 설치에는 사이트·프로그램·파일·폴더가 비어 있음. 설정에 교육 바로가기 추가 단추 없음. 업무도구는 Network·CCTV·주소 무늬. 컴퓨터도구·업무자료는 앱에 있음. 이미 쓰는 PC 목록은 그대로. 할 일 샘플도 넣지 않음. 홈 자주 사용하는 도구의 사이트·프로그램·파일·폴더는 비어 있으면 끌어놓기나 + 안내가 나옴
