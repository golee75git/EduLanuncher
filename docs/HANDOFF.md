...
브랜치: `main`  
최신 커밋 시점의 앱 버전: `0.1.99-20260924`
...
- 홈은 교육업무 런처 헤더, 시간 인사, 검색(Ctrl+K), 공지 카드, 자주 사용하는 도구 카드. 최소 너비 1열, 기본 2열, 약 560px 이상 3열. 할 일·최근 사용·검색 결과 구역은 그대로. 메모는 아래, 상태 줄은 오른쪽 아래. 모두 화면은 설정에서 1열·2열
