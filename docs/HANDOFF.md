...
브랜치: `main`  
최신 커밋 시점의 앱 버전: `0.1.57-20260921`
...
- GitHub Release에 `0.1.57` 설치파일 업로드
...
- 설정의 바탕화면 미니 창(기본 끔). 켜면 왼쪽 아래에 오늘 남은 할 일 개수와 런처 열기만 있는 작은 창. 패널을 숨겨도 남음. 제목 줄 X는 그 창만 숨김. Windows 위젯 보드·바탕화면 아이콘 뒤 붙이기 아님
