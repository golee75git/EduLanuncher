...
- 홈·업무자료 검색 결과 위에 업무 그림. 크게 보기는 런처에서 조금 더 넓게 펼치고 그림을 창에 채움(`work-map`). 단추·휠로 크기, 끌어서 이동. 자체 SVG. 새 패키지 없음. 별도 창은 패널과 같은 index.html을 열고 JSON 저장소는 열지 않음. 이미 있는 창은 지우고 다시 연다
