export const SITE_CONFIG = {
  ...
  setupFile: "EduLauncher_0.1.73-20260923_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-23_0732_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.73-20260923/EduLauncher_0.1.73-20260923_x64-setup.exe",
} as const;
