export const SITE_CONFIG = {
  ...
  setupFile: "EduLauncher_0.1.100-20260924_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-24_1727_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.100-20260924/EduLauncher_0.1.100-20260924_x64-setup.exe",
} as const;
