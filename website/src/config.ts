export const SITE_CONFIG = {
  ...
  version: "0.1.66-20260922",
  setupFile: "EduLauncher_0.1.66-20260922_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-22_1333_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.66-20260922/EduLauncher_0.1.66-20260922_x64-setup.exe",
} as const;
