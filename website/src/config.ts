export const SITE_CONFIG = {
  ...
  setupFile: "EduLauncher_0.1.111-20260926_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-26_0913_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.111-20260926/EduLauncher_0.1.111-20260926_x64-setup.exe",
} as const;
