export const SITE_CONFIG = {
  ...
  version: "0.1.60-20260921",
  setupFile: "EduLauncher_0.1.60-20260921_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-21_2322_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.60-20260921/EduLauncher_0.1.60-20260921_x64-setup.exe",
} as const;
