export const SITE_CONFIG = {
  ...
  version: "0.1.28-20260919",
  setupFile: "EduLauncher_0.1.28-20260919_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-19_1250_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.28-20260919/EduLauncher_0.1.28-20260919_x64-setup.exe",
} as const;
