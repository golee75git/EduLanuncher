export const SITE_CONFIG = {
  ...
  setupFile: "EduLauncher_0.1.108-20260925_x64-setup.exe",
  setupFileDated: "EduLauncher_2026-09-25_1509_x64-setup.exe",
  setupDownloadUrl:
    "https://github.com/golee75git/EduLanuncher/releases/download/0.1.108-20260925/EduLauncher_0.1.108-20260925_x64-setup.exe",
} as const;
