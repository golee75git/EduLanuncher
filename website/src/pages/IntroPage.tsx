...
const FEATURES = [
  {
    ...
    body: "평소에는 작업 표시줄 알림 영역에 있습니다. 실행 중에는 작업 표시줄에도 아이콘이 있습니다. 창을 닫아도 아이콘은 남고, 누르면 패널이 다시 열립니다. 트레이·표시줄 아이콘 또는 Ctrl+Alt+E로도 엽니다. 처음은 440×650이고, 모서리로 크기를 바꾼 값은 이 PC에 남습니다.",
  },
  {
