    ...
    <div className="flex h-full flex-col bg-paper">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="업무자료">
          <p className="text-xs leading-5 text-quiet">
            홈 검색 또는 업무도구의 업무자료에서 주제를 찾습니다. 업무지도는 마인드맵 계층을 목록으로 보여 줍니다. 교육행정전자서명(EPKI) 인증서는 같은 JSON에서 검색·목록·상세가 이어집니다. 최신 여부 확인이 필요한 항목만 따로 볼 수 있습니다.
          </p>
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>업무도구 칸의 업무자료에서 검색결과와 업무지도를 고릅니다. 업무지도 항목을 누르면 자세한 업무가 열립니다. 인증서(EPKI)는 같은 목록에서 발급·갱신·재발급·백업을 찾습니다. JSON에 주소가 있는 자료만 바깥에서 엽니다. 학교알리미·나라장터·교육시설 통합정보망은 제목이 일치하면 공식 누리집을 엽니다.</li>
