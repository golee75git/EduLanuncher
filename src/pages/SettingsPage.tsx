      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>홈 검색에 업무를 적으면 관련 주제가 바로가기보다 먼저 나옵니다. 업무 주제 위에 업무 그림이 있고, 크게 보기에서 런처 옆을 조금 더 넓게 펼칩니다. 그림은 창을 채웁니다. 확대·축소 단추와 마우스 휠로 크기를 바꾸고, 끌어서 옮깁니다. 그 창은 제목 줄 X로 닫습니다. 패널을 숨기면 같이 숨습니다. 프로그램은 트레이 종료로 끕니다. 주제를 연 뒤 뒤로 가면 검색어와 그림·목록이 그대로 있습니다. 처음 화면을 누르면 빈 홈으로 갑니다.</li>
