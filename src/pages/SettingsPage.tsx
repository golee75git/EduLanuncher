    ...
    <div className="flex h-full flex-col bg-paper">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="업무자료">
          <p className="text-xs leading-5 text-quiet">
            홈 검색 또는 업무도구의 업무자료에서 주제를 찾습니다. 검색 결과 위에 업무 그림이 나오고, 크게 보기에서 별도 창으로 봅니다. 자세한 업무에서 뒤로 가면 방금 검색한 화면이 다시 나옵니다. 업무지도 탭은 목록입니다. 교육행정전자서명(EPKI) 인증서는 같은 JSON에서 검색·목록·상세가 이어집니다.
          </p>
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>홈 검색에 업무를 적으면 관련 주제가 바로가기보다 먼저 나옵니다. 업무 주제 위에 업무 그림이 있고, 크게 보기에서 별도 창으로 봅니다. 그 창은 제목 줄 X로 닫습니다. 프로그램은 트레이 종료로 끕니다. 주제를 연 뒤 뒤로 가면 검색어와 그림·목록이 그대로 있습니다. 처음 화면을 누르면 빈 홈으로 갑니다.</li>
