      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="바로가기 Pack">
          <p className="text-xs leading-5 text-quiet">
            ...
            처음 설치에는 사이트·프로그램·파일·폴더가 비어 있습니다. 할 일도 비어 있습니다. 업무도구와 컴퓨터도구는 앱에 있습니다.
          </p>
          <button
            type="button"
        ...
        <SettingsCard title="공지·사이트 Pack">
          <p className="text-xs leading-5 text-quiet">
            ...
            않습니다. 받는 쪽에서 공지는 고르고, 사이트는 함께 넣습니다. 백업 파일과는 다릅니다.
          </p>
        ...
        <SettingsCard title="업무자료">
          <p className="text-xs leading-5 text-quiet">
            홈 검색 또는 업무도구의 업무자료에서 주제를 찾습니다. 검색 결과 위에 업무 그림이 나오고, 크게 보기에서 런처 옆을 조금 더 넓게 펼칩니다. 그림은 그 창을 채웁니다. 자세한 업무에서 뒤로 가면 방금 검색한 화면이 다시 나옵니다. 업무지도 탭은 목록입니다. 교육행정전자서명(EPKI) 인증서는 같은 JSON에서 검색·목록·상세가 이어집니다.
          </p>
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>처음 설치에는 사이트·프로그램·파일·폴더와 할 일이 비어 있습니다. 홈의 자주 사용하는 도구에 끌어놓기나 + 안내가 나옵니다. 종류 이름(사이트·프로그램 등)은 구역 제목보다 한 단계 작게 두고, 모두·즐겨찾기 등 단추 글자는 그대로입니다. 종류마다 2열로 최대 6개까지 보이고, 더 있으면 모두에서 봅니다. + 또는 끌어놓기로 넣고, 설정에서 Pack으로 나눠 줍니다. 이미 쓰는 PC의 바로가기·할 일 목록은 그대로입니다. 업무도구에는 Network·CCTV·QR코드 넣기가 있고, 컴퓨터도구와 업무자료는 앱에 있습니다.</li>
            ...
            <li>홈 검색에 업무를 적으면 관련 주제가 바로가기보다 먼저 나옵니다. 업무 주제 위에 업무 그림이 있고, 크게 보기에서 런처 옆을 조금 더 넓게 펼칩니다. 그림은 창을 채웁니다. 확대·축소 단추와 마우스 휠로 크기를 바꾸고, 끌어서 옮깁니다. 상자를 누르면 패널에 자세한 업무가 열립니다. 그 창은 제목 줄 X로 닫습니다. 패널을 숨기면 같이 숨습니다. 프로그램은 트레이 종료로 끕니다. 주제를 연 뒤 위쪽 뒤로 또는 오른쪽 아래 이전화면을 누르면 검색어와 그림·목록이 그대로 있습니다. 처음 화면을 누르면 빈 홈으로 갑니다.</li>
            ...
            <li>업무도구 칸의 업무자료에서 검색결과와 업무지도를 고릅니다. 검색결과 위에도 업무 그림이 있습니다. 주제를 연 뒤 뒤로 가면 방금 검색한 화면이 다시 나옵니다. 업무지도 항목을 누르면 자세한 업무가 열립니다. 인증서(EPKI)는 같은 목록에서 발급·갱신·재발급·백업을 찾습니다. JSON에 주소가 있는 자료만 바깥에서 엽니다. 학교알리미·나라장터·교육시설 통합정보망은 제목이 일치하면 공식 누리집을 엽니다.</li>
