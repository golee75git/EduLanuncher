      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>업무도구 칸의 업무자료에서 검색결과와 업무지도를 고릅니다. 검색결과 위에도 업무 그림이 있습니다. 관련 업무를 연 뒤 뒤로 가면 방금 검색한 화면이 다시 나옵니다. 업무지도 항목을 누르면 자세한 업무가 열립니다. 인증서(EPKI)는 같은 목록에서 발급·갱신·재발급·백업을 찾습니다. JSON에 주소가 있는 자료만 바깥에서 엽니다. 자료에는 강원 기준, 전국 공통, 타 교육청 참고, 지역 확인 필요가 표시됩니다. 타 교육청 값은 강원 기준으로 바꾸지 않습니다. 학교알리미·나라장터·교육시설 통합정보망은 제목이 일치하면 공식 누리집을 엽니다.</li>
