      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>설정의 보기에서 서류·밝은 화면·어두운 화면 스킨과 모두 목록 1열·2열을 고릅니다. 홈의 자주 사용하는 도구는 창을 최소 너비로 줄이면 1열, 기본 창에서는 2열, 가로로 넓히면(약 560px 이상) 3열입니다. 모두 목록은 1열 설정을 유지하고, 2열 설정일 때 같은 너비에서 3열이 됩니다. 홈 검색 빈 구역 숨김은 기본이 꺼져 있어 지금처럼 빈 안내를 둡니다. 켜면 일치가 없는 구역만 숨기고 순서는 그대로입니다.</li>
