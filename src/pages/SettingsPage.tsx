      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>홈 검색 결과는 관련 도구, 최근 사용, 이 PC 폴더, 학교, PC 문제 해결, 관련 업무 순입니다. 관련 도구 줄마다 사이트·프로그램·파일·폴더·업무도구가 보입니다. PC 문제 해결은 학교와 관련 업무 사이에 최대 5줄이 나오고, 더 보기에서 분류·검색 목록을 엽니다. 관련 업무와 섞지 않습니다. 관련 업무 위에 업무 그림이 있고, 크게 보기에서 런처 옆을 조금 더 넓게 펼칩니다. 그림은 창을 채웁니다. 확대·축소 단추와 마우스 휠로 크기를 바꾸고, 끌어서 옮깁니다. 상자를 누르면 패널에 자세한 업무가 열립니다. 그 창은 제목 줄 X로 닫습니다. 패널을 숨기면 같이 숨습니다. 프로그램은 트레이 종료로 끕니다. 관련 업무를 연 뒤 위쪽 뒤로 또는 오른쪽 아래 이전화면을 누르면 검색어와 그림·목록이 그대로 있습니다. 처음 화면을 누르면 빈 홈으로 갑니다.</li>
            ...
            <li>설정 맨 아래 소개 사이트에서 설치 안내 웹 주소를 엽니다. 소개 웹은 website 폴더만 올리고, 설치 파일은 GitHub Releases에 있습니다. 프로그램을 켤 때 한 번, 그리고 설정의 프로그램 정보에서 이 PC 버전과 GitHub 최신 태그를 비교합니다. 새 설치 파일이 있으면 패널에 안내가 나오고 설치 안내만 엽니다. 창을 숨긴 채 켜면 다음에 패널을 열었을 때 보입니다. 자동으로 설치하거나 파일을 받지는 않습니다.</li>
