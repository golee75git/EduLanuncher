      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            ...
            <li>설정의 보기에서 서류·밝은 화면·어두운 화면 스킨과 모두 목록 1열·2열을 고릅니다. 2열일 때 패널을 가로로 넓히면 홈·모두 목록이 3열로 바뀝니다. 홈 검색 빈 구역 숨김은 기본이 꺼져 있어 지금처럼 빈 안내를 둡니다. 켜면 일치가 없는 구역만 숨기고 순서는 그대로입니다.</li>
            <li>트레이, 작업 표시줄 아이콘 또는 Ctrl+Alt+E로 패널을 엽니다. 창을 닫아도 작업 표시줄 아이콘은 남고, 아이콘을 누르면 설정한 자리(기본은 오른쪽 아래)에 다시 열립니다. 컴퓨터를 켜 두면 아이콘이 있습니다. 완전히 끄려면 트레이에서 종료합니다. 창 모서리를 끌어 크기를 바꿀 수 있고, 바꾼 크기는 이 PC에 남습니다. 처음 설치는 440×650입니다. 가로로 넓히면(약 560px 이상) 자주 사용하는 도구·모두 목록이 3열로 보입니다.</li>
            ...
            <li>주소·파일·Pack을 패널에 끌어 넣을 수 있습니다. 폴더는 Windows 탐색기(explorer.exe)로 엽니다. 파일·프로그램·사이트는 이전과 같습니다. 즐겨찾기 표시줄에서 끌어 올 때 브라우저가 넘긴 PNG만 바로가기 그림으로 남깁니다. 사이트에 다시 접속하지 않습니다. JPEG·ICO는 넣지 않습니다. 이미 있는 주소는 그림이 비어 있을 때만 채웁니다.</li>
