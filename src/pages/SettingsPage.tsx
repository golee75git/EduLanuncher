      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SettingsCard title="사용 방법">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-4 text-xs leading-5 text-quiet">
            <li>설치 창은 한글입니다. 이미 설치된 버전 위에 다시 설치하면, 이전 버전을 지운 뒤 닫기 단추 없이 새 설치가 이어집니다. 그 과정에서는 바로가기와 이 PC의 목록을 지우지 않습니다.</li>
            <li>개인 사용 PC에만 설치하세요. 공용 PC·실습실·다른 사람 계정에는 설치하지 않습니다. 목록은 설치한 컴퓨터에만 남습니다. 런처는 컴퓨터에 있는 파일이나 폴더를 삭제하지는 않습니다.</li>
            <li>설치가 끝나면 프로그램이 바로 실행되고, 처음에는 시작 시 자동 실행·시작 시 창 표시가 켜져 있습니다. 설정에서 끌 수 있습니다. Pack 연결과 시작 시 자동 실행을 넣을 때 검은 콘솔 창은 띄우지 않습니다.</li>
            ...
            <li>트레이, 작업 표시줄 아이콘 또는 Ctrl+Alt+E로 패널을 엽니다. 홈에서 Ctrl+K를 누르면 검색창으로 이동합니다. 창을 닫아도 작업 표시줄 아이콘은 남고, 아이콘을 누르면 설정한 자리(기본은 오른쪽 아래)에 다시 열립니다. 컴퓨터를 켜 두면 아이콘이 있습니다. 완전히 끄려면 트레이에서 종료합니다. 창 모서리를 끌어 크기를 바꿀 수 있고, 바꾼 크기는 이 PC에 남습니다. 처음 설치는 440×650입니다.</li>
